...
// See https://f.osdev.org/viewtopic.php?t=36944
static void Seventh_Suprious_Interrupte_Handler(struct Interrupt_State* state) {
...
void Init_Interrupts(void)
{
    ...
    Install_Interrupt_Handler(0x27, Seventh_Suprious_Interrupte_Handler);
